...
int main() {
    ...
    printf("Lista utilizada: [arroz, batata, cebola, detergente, feijao, leite, macarrao, oleo, sal]\n");
    printf("-------------------------------------------------------------\n\n");
    ...
    return 0; // Indica que o progama terminou
}
...
int buscaSequencialRecursiva_aux(const char* lista[], int tamanho, const char* item, int indice) {
    ...
    // Chamamos a função novamente, mas agora para o próximo índice (índice + 1).
