'''
Cria uma progama em python com interface grafica, 
que recebe  dois números e realiza a soma de ambos.
'''
...
def somar_numeros():
    ...
    resultado = num1 + num2
    messagebox.showinfo('Resultado', f'A soma dos número é: {resultado}')
...
# criar botão
botao_somar = tk.Button(janela, text='SOMA', command=somar_numeros)
